...
class model_deep_artifact:
	...
	def __init__(self,data,batch_size = 200,nchannels=25,nsamples= 100,tf_version = '1.2.1'):
...
def next_batch_ratio(artifact_data,clean_data,nartifact,nclean):
...
def deepnn(x,nchannels,nsamples,fmap_size = 2400):
	...
	with tf.name_scope('fc1'):
		W_fc1 = weight_variable([3 * 13 * 256, fmap_size])
		b_fc1 = bias_variable([fmap_size])
		print(W_fc1,'W_fc1')
		print(b_fc1,'b_fc1')

		h_pool3_flat = tf.reshape(h_pool3, [-1,3 * 13 * 256],name = 'h_pool3_flat-bla')
		h_fc1 = tf.nn.relu(tf.matmul(h_pool3_flat, W_fc1) + b_fc1,name='h_fc1-bla')
		print(h_pool3_flat,'h_pool3_flat')
		print(h_fc1,'h_fc1')
