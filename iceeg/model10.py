...
'''
use conv2d_alt 2X1 with stride 2X1 adn padding valid to reduce input
from 52X100 -> 26X100
poor results on first 1000 .637
'''
...
def deepnn(x,nchannels,nsamples,kernel_size,fmap_size = 2400):
	...
	with tf.name_scope('conv0'):
		...
		h_conv0 = tf.nn.relu(conv2d_alt(x_image, W_conv0) + b_conv0)
